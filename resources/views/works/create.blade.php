    ...
    <div class="row justify-content-center">
        <div class="card w-75">
            <div class="card-header">
                ...
                <h3 class="text-center text-info">Add Work</h3>
            </div>
            <div class="card-body">
                ...
                <form method="POST" action="/works">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="short_desc" id="short_desc" class="form-control @error('short_desc') is-invalid @enderror" placeholder="Short desc" value="{{ old('short_desc') }}">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="long_desc" id="long_desc" class="form-control @error('long_desc') is-invalid @enderror" placeholder="Long desc" value="{{ old('long_desc') }}">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <input type="date" name="start_date" id="start_date" class="form-control @error('start_date') is-invalid @enderror" placeholder="Start date" value="{{ old('start_date') }}">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <input type="date" name="completion_date" id="completion_date" class="form-control @error('completion_date') is-invalid @enderror" placeholder="Completion date" value="{{ old('completion_date') }}">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="penalty_rate" id="penalty_rate" class="form-control @error('penalty_rate') is-invalid @enderror" placeholder="Penalty rate" value="{{ old('penalty_rate') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="contractor" id="contractor" class="form-control">
                                @foreach ($contractors as $contractor)
                                    <option value="{{ $contractor->id }}">{{ $contractor->contact_person_name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="addr_1" id="addr_1" class="form-control @error('addr_1') is-invalid @enderror" placeholder="Address 1" value="{{ old('addr_1') }}">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="addr_2" id="addr_2" class="form-control @error('addr_2') is-invalid @enderror" placeholder="Address 2" value="{{ old('addr_2') }}">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="state" id="state" class="form-control @error('state') is-invalid @enderror" placeholder="State" value="{{ old('state') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="road_type" id="road_type" class="form-control">
                                @foreach ($roadTypes as $roadType)
                                    <option value="{{ $roadType->id }}">{{ $roadType->description }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <input type="date" name="expiry_date" id="expiry_date" class="form-control @error('expiry_date') is-invalid @enderror" placeholder="Expiry date" value="{{ old('expiry_date') }}">
